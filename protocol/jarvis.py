...
class Jarvis:
    def __init__(self, receive_port=12345, send_port=12345,
    ...
    def load_adjacency_list(file_path):
        ...
        try:
            with open(file_path, "r") as file:
                ...
                if not data:
                    raise ValueError("Adjacency list file is empty.")
    ...
    def handle_message(self, data):
        ...
        try:
            ...
            if message["dest_ip"] == self.local_ip:
                ...
                if next_hop:
                    print(
                        f"Message hopping: {message['source_ip']} -> {self.local_ip} -> {next_hop} -> {message['dest_ip']}")
